      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem className="hidden md:block">
              <BreadcrumbLink href="/customer/events">My Events</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator className="hidden md:block" />
            <BreadcrumbItem>
              <BreadcrumbPage>Event History</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </header>
          ...
          <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
            <div className="px-4 lg:px-6">
              ...
              <p className="text-muted-foreground">
                View your past event attendance and experiences.
              </p>
            </div>
            <div className="px-4 lg:px-6">
              <p>Event history features coming soon...</p>
            </div>
          </div>
        </div>
      </div>
